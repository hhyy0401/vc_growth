...
Naming: {mode}_{eccOrder}
  mode ∈ {angle, polar, euclidean, x}
  eccOrder ∈ {fp, pf, random}  (fp = fovea-to-periphery, pf = periphery-to-fovea)

Usage:
  from custom_batch import get_custom_node_order
  ordered_nodes, batch_assignments = get_custom_node_order(DF, "polar", "fp", n_batches=30)
"""
